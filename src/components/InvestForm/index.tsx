      ...
      <Form id="form-simulator" className="form-container" method="get" action="#" onSubmit={handleSearchSimulation}>
        <div className="yield">
          <div className="yieldDiv">
            ...
            <div className="form-group-radio">
              <LabelOptions htmlFor="bruto" isActive={yieldInput === 'bruto'}>
                {yieldInput === 'bruto' && <FiCheckSquare size={16} />}
                Bruto
                <input type="button" id="bruto" onClick={() => setYieldInput('bruto')} />
              </LabelOptions>
              <div className="inner"></div>
              <LabelOptions htmlFor="liquido" id="liquidoLabel" isActive={yieldInput === 'liquido'}>
                {yieldInput === 'liquido' && <FiCheckSquare size={16} />}
                Líquido
                <input type="button" id="liquido" onClick={() => setYieldInput('liquido')} />
              </LabelOptions>
            </div>
          </div>

          <div className="form-group">
            <Label htmlFor="aport" isWrong={errorsForm.indexOf('aport') !== -1}>
              Aporte Inicial
            </Label>
            ...
            <small style={{ color: '#ff0000aa' }}>
              {errorsForm.indexOf('aport') !== -1 && 'Aporte inicial deve ser um número!'}
            </small>
          </div>
          <div className="form-group">
            <Label htmlFor="aport" isWrong={errorsForm.indexOf('deadline') !== -1}>
              Prazo (em meses)
            </Label>
            <input
              type="text"
          ...
          <div className="form-group">
            <label htmlFor="aport">IPCA (ao ano)</label>
            <input type="text" name="ipca" id="ipca" value={ipca} readOnly />
          </div>

          <button type="reset" id="reset-simulator-form" onClick={handleResetForm}>
            Limpar campos
          </button>
        </div>
        <div className="index-type">
          <div className="yieldDiv">
            ...
            <div className="form-group-radio">
              <LabelOptions htmlFor="pre" isActive={indexTypeInput === 'pre'}>
                {indexTypeInput === 'pre' && <FiCheckSquare size={16} />}
                Pré
                <input type="button" id="pre" onClick={() => setIndexTypeInput('pre')} />
              </LabelOptions>
              <div className="inner"></div>
              <LabelOptions htmlFor="pos" isActive={indexTypeInput === 'pos'}>
                {indexTypeInput === 'pos' && <FiCheckSquare size={16} />}
                Pós
                <input type="button" id="pos" onClick={() => setIndexTypeInput('pos')} />
              </LabelOptions>
              <LabelOptions htmlFor="fixado" isActive={indexTypeInput === 'fixado'}>
                {indexTypeInput === 'fixado' && <FiCheckSquare size={16} />}
                Fixado
                <input type="button" id="fixado" onClick={() => setIndexTypeInput('fixado')} />
              </LabelOptions>
            </div>
          </div>
          <div className="form-group">
            <Label htmlFor="monthlyAport" isWrong={errorsForm.indexOf('monthlyAport') !== -1}>
              Aporte Mensal
            </Label>
            <span className="currency-input">
              R$
            ...
            <small style={{ color: '#ff0000' }}>
              {errorsForm.indexOf('monthlyAport') !== -1 && 'Aporte mensal deve ser um número!'}
            </small>
          </div>
          <div className="form-group">
            <Label htmlFor="rentability" isWrong={errorsForm.indexOf('rentability') !== -1}>
              Rentabilidade
            </Label>
            <input
              type="text"
            ...
            />
            <small style={{ color: '#ff0000aa' }}>
              {errorsForm.indexOf('rentability') !== -1 && 'Rentabilidade deve ser um número!'}
            </small>
          </div>
          <div className="form-group">
            <label htmlFor="cdi">CDI(ao ano)</label>
            <input type="text" name="cdi" id="cdi" value={cdi} readOnly />
          </div>
          <ButtonSubmit
            type="submit"
          ...
          <button type="reset" id="reset-simulator-form-mobile" onClick={handleResetForm}>
            Limpar campos
          </button>
        </div>
      </Form>
